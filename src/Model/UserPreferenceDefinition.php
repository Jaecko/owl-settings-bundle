...
class UserPreferenceDefinition
{
    public function __construct(
        ...
        private readonly ?string $inheritFrom = null,
    ...
    /**
     * Whether this preference falls back to a global setting.
     */
    public function inheritsFromGlobal(): bool
    {
        return $this->inheritFrom !== null;
    }
